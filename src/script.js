...
var budget_input = document.getElementById("budget-input");
 ...
 var new_budget = document.getElementById("new-budget");
...
var tittle_product = document.getElementById("tittle-product")
 ...
 var remaining_amount = document.getElementById("remaining-amount");
...
check_amount.addEventListener("click",function(){
    ...
    expenses_list_items.innerHTML += ` <li>${tittle_product.value} <span class="cost">${cost_product.value}</span> <span class="del">delete</li>`;
    remaining_amount.innerText = `Now you have Remaining Amount is ${parseInt(total_balance_value.innerText)}`
